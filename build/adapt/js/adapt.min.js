require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/mediaelement-and-player', 'libraries/SCORM_API_wrapper', 'libraries/lzma-min', 'libraries/lzma_worker-min.js', 'libraries/js-cookie.js', 'libraries/jquery.keycombo'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, mediaelementAndPlayer, pipwerks, lzmaMin, lzma_workerMin_js, Cookies, jquery_keycombo) { 'use strict';
  ...
  class DrawerView extends Backbone__default["default"].View {
    ...
    showDrawer(emptyDrawer) {
      ...
      this.$el.removeClass('u-display-none').attr('aria-hidden', 'false').attr('aria-expanded', 'true');
      if (!this._isVisible) {
    ...
    hideDrawer($toElement) {
      ...
      const complete = () => {
        this.$el.removeAttr('style').addClass('u-display-none').attr('aria-hidden', 'true').attr('aria-expanded', 'false');
        this.$('.js-drawer-holder').removeAttr('role');
  ...
  class DOMElementModifications extends Backbone__default["default"].View {
    ...
    on() {
      const rtn = super.on(...arguments);
      if (this.shouldListen) this.startWatching();
      return rtn;
    }
    once() {
      const rtn = super.once(...arguments);
      if (this.shouldListen) this.startWatching();
      return rtn;
    }
    listenToOnce() {
      const rtn = super.listenToOnce(...arguments);
      if (this.shouldListen) this.startWatching();
      return rtn;
    }
    off() {
      const rtn = super.off(...arguments);
      if (!this.shouldListen) this.stopWatching();
      return rtn;
    }
    stopListening() {
      const rtn = super.stopListening(...arguments);
      if (!this.shouldListen) this.stopWatching();
      return rtn;
    }
    get shouldListen() {
  ...
  __AMD("core/js/DOMElementModifications", documentModifications);
  ...
  class QuestionModel extends ComponentModel$1 {
    ...
    getFeedback() {
      let feedback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.get('_feedback');
      if (!feedback) return {};
      ...
      const feedbackConfig = {
        altTitle: feedback.altTitle || Adapt$1.course.get('_globals')._accessibility.altFeedbackTitle || '',
  ...
  var HotgraphicModel = __AMD("components/adapt-contrib-hotgraphic/js/hotgraphicModel", class HotgraphicModel extends ItemsComponentModel {
    ...
    setUpItems() {
      ...
      this.getChildren().forEach((child, index) => {
        ...
        tooltips$1.register(tooltipConfig);
      });
    }
    ...
    const GenericAPI = {
      ...
      initialize() {
        ...
        if (isUsingLegacyKeys) {
          const reworked = {};
          Object.entries(defaults).forEach(_ref3 => {
            let [path, value] = _ref3;
            return set(reworked, path, value);
          });
          Object.entries(entries).forEach(_ref4 => {
  ...
  function setupFooter(footerData) {
    var footerModel = new Backbone__default["default"].Model(footerData);
    var footerCollection = new Backbone__default["default"].Collection(footerModel.get('_footerItems'));
    new FooterView({
      model: footerModel,
  ...
  function initFooter() {
    var _oFooter = Adapt$1.course.get('_footer');
    if (!_oFooter || _oFooter._isEnabled === false) return;
    setupFooter(_oFooter);
  }
  var FooterView = Backbone__default["default"].View.extend({
    className: "footer",
    initialize: function () {
  ...
  Adapt$1.on('adapt:start', initFooter);
  ...
  class NavigationLogoView extends Backbone.View {
    ...
    attributes() {
      return {
        'data-order': Adapt$1.course.get('_globals')?._extensions?._navigationLogo?._navOrder || 0
      };
    }
    initialize() {
      this.listenTo(Adapt$1, 'device:changed', this.changed);
    ...
    changed() {
      ...
      this.hideForMobile();
      ReactDOM__default["default"].render(React__default["default"].createElement(templates.navigationLogo, this.model.toJSON()), this.el);
    }
    setIsDeviceSmall() {
      this.model.set('_isDeviceSmall', device$1.screenSize === 'small');
    }
    setLogoImageSrc() {
  ...
  var NavigationLogoView$1 = __AMD("extensions/adapt-navigationLogo/js/NavigationLogoView", NavigationLogoView);

  class NavigationLogo extends Backbone.Controller {
    initialize() {
      this.listenTo(Adapt$1, 'adapt:initialize', this.onDataReady);
    }
    onDataReady() {
      if (this.logoView) this.logoView.remove();
      const config = Adapt$1.course.get('_navigationLogo');
      if (!config || !config._isEnabled) return;
      const model = new Backbone.Model(config);
      this.logoView = new NavigationLogoView$1({
        model
      });
  ...
  __AMD("extensions/adapt-navigationLogo/js/adapt-navigationLogo", new NavigationLogo());
  ...
  register("image", function Image(props) {
    ...
    return React__default["default"].createElement("span", {
      ...
      className: classes([prefixClasses(props.classNamePrefixes, ['__image']), props?._srcFocalPoint && `object-position-${props?._srcFocalPoint}`]),
      src: src,
  ...
  register("hotgraphicLayoutPins", function HotgraphicLayoutPins(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        ...
        src: _pin.src,
        "aria-hidden": "true"
      })), !_pin.src && _useNumberedPins && !_isVisited && React__default["default"].createElement("span", {
        className: "hotgraphic__pin-number",
        "aria-hidden": "true"
      }, index + 1), (!_pin.src && !_useNumberedPins || !_pin.src && _isVisited) && React__default["default"].createElement("span", {
        className: "icon",
        "aria-hidden": "true"
      })));
    })));
  ...
  register("resources", function Resources(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      className: classes(['resources__filter', `has-${resourcesGetColumnCount(resources)}-columns`, resourcesGetColumnCount(resources) > 4 && 'has-extra-types'])
    }, React__default["default"].createElement("div", {
  ...
  register("navigationLogo", function NavigationLogo(props) {
    const {
      _graphic,
      src,
      _fillNavHeight
    ...
    return React__default["default"].createElement("div", {
      className: classes(['navigation-logo__inner', _fillNavHeight && 'is-fill'])
    }, React__default["default"].createElement("img", {
